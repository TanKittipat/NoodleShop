...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_POST['MenuID']) && !empty($_POST['MenuName'])) {
            echo '<br>' . $_POST['MenuID'];
            ...
            $sql = "insert into menu 
							values (:MenuID, :MenuName, :Price, :TypeID, :image)";

            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':MenuID', $_POST['MenuID']);
            $stmt->bindParam(':MenuName', $_POST['MenuName']);
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4"> <br>
                <h3>ฟอร์มเพิ่มข้อมูลเมนูอาหาร</h3>
                <form action="addFood_dropdown.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="รหัสเมนู" name="MenuID" required>
                    <br> <br>
                    <input type="text" placeholder="เมนู" name="MenuName" required>
                    <br> <br>
                    <input type="number" placeholder="ราคา" name="Price">
                    <br> <br>
                    <label>เลือกประเภทเมนู</label>
                    <select name="TypeID">
